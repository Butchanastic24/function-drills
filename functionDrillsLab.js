...
const jsNinja = () => {
  let phrase = console.log("I am a Javascript ninja")
  return phrase
}
jsNinja()
...
const printAllNames = (arrOfNames) => {
...
const upperString = (sampleString) => {console.log(sampleString.toUpperCase())}
...
console.log(emailCheck(" email@gmail.com "))
...
const totalFrogs2 = () =>{
  console.log("Whoops I accidentally made the function with that bug already fixed")
}
totalFrogs2()
...
const isAscending = (samArray) => {
  let arrAscending = true
  for (let i = 0; i < samArray.length; i++){
    if (samArray[i] > samArray[(i + 1)]){
      arrAscending = false
      break
    }
  }
